...
A modern, full-featured library management system built with Node.js, Express, MongoDB, and EJS templating. Features a beautiful responsive UI with dark mode support and comprehensive book management capabilities.
...
### 📖 Book Catalog
- **Browse Books**: View all available books in a beautiful card-based grid layout
...
- **Transaction History**: View your borrowing history with:
  - Transaction dates
  - Book titles
